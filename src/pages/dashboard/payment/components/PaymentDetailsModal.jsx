        ...
        >
            <Descriptions bordered column={2} size="small" className="mb-6">
                ...
                <Descriptions.Item label="Amount Due" span={2}>
                    <Text strong style={{ fontSize: 16 }}>₹{Number(payment.amount_due).toLocaleString()}</Text>
                </Descriptions.Item>
            ...
            <Title level={5} style={{ marginTop: 20 }}>Transaction History</Title>
            {status === 'loading_transactions' ? <div className='text-center p-4'><Spin /></div> :
                <Table
