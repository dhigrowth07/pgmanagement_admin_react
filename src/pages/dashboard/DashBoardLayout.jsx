...
import { logout, selectUser, updateUserProfile, selectAuthStatus } from "../../redux/auth/authSlice";
  ...
  return (
    <Layout className="h-screen rounded-lg bg-[#F5F5F5] overflow-hidden shadow-lg md:p-1 p-0">
      ...
      <Layout className="md:m-2 m-0.5 rounded-lg overflow-hidden">
        <Header style={{ background: "blue", color: "white" }} className="px-3 text-white text-center flex items-center justify-center rounded-lg mb-2 shadow-lg min-h-[8px] md:min-h-[100px]">
